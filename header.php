...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-144304015-1"></script>
    <script>
                ...
                <div class="row">
                    <div class="col-12 col-top-header">
                        ...
                        <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"
                            ...
                            <u><?php _e('My Account','woocommerce'); ?></u></a>
                        <?php } 
                            else { ?>
                        <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"
                        ...
                        <div class="social-header">
                            ...
                            <a class="righticon" href="https://www.instagram.com/andcowoman/" target="_blank">
                                <img src="/wp-content/themes/andcowoman/img/icons/instagram.svg">
                            </a>
                            <a class="righticon" href="https://www.facebook.com/AndCo-Woman-891634994344460/"
                                target="_blank">
                                <img src="/wp-content/themes/andcowoman/img/icons/facebook.svg">
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row row-header relative bga">
                                    ...
                                    <div class="col-6 col-lg-2 justify-content-lg-start d-flex justify-content-center">
                                        <a class="navbar-brand" href="<?php if(ICL_LANGUAGE_CODE=='nl'): ?>
                                                    ...
                                                    <?php endif; ?>">
                                            <img id="navbar-id"
                                                src="/wp-content/themes/andcowoman/img/and-co-woman-logo-blk.png"></a>
                                    </div>
                                                        ...
                                                        <form role="search" method="get"
                                                            ...
                                                            <button class="button-search button-search-add"
                                                                type="submit" value="Search" aria-label="Search"><img
                                                                    src="/wp-content/themes/andcowoman/img/icons/search.svg"></button>
                                                            <div class="button-one-search"><img
                                                                    src="/wp-content/themes/andcowoman/img/icons/search.svg">
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="img-close">
                                                        <img src="/wp-content/themes/andcowoman/img/icons/x.svg">
                                                    </div>
                    ...
                    <div class="social-nav">
                        <div class="social-header">
                            <a class="margin-px-social" href="https://www.instagram.com/andcowoman/">
                                <img src="/wp-content/themes/andcowoman/img/icons/instagram.svg" target="_blank">
                            </a>
                    ...
                    <?php if(ICL_LANGUAGE_CODE=='nl'): ?>
                     ...
                     <?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
                      ...
                      <?php elseif(ICL_LANGUAGE_CODE=='de'): ?>
                        /?lang=de
                      <?php endif; ?>">
                            <img id="nav-logo-img" src="/wp-content/themes/andcowoman/img/and-co-woman-logo-blk.png"></a>
                    </div>
                </div>
        </section>
        <!-- Right slider  -->
