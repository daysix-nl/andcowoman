            ...
            <div class="row p-left-right">
                <div class="col-12 col-lg-3">
                    <div class="row d-flex align-items-center ">
                        ...
                        <img class="img-icon-natural" src="/wp-content/themes/andcowoman/img/icons/and-co-woman-planet-and-co.svg">
                    </div> -->
                    </div>
                </div>
            ...
            <div class="row p-left-right">
                <div class="col-12 col-lg-3">
                    <div class="row d-flex align-items-center ">
                        ...
                        <div class="pb-quarter d-none d-lg-block"></div>
                        <!-- <div class="col-6 col-lg-12 d-flex justify-content-end justify-content-lg-start">
                        <img class="img-icon-planet" src="/wp-content/themes/andcowoman/img/and-co-woman-pure-natural.svg">
                    </div> -->
                    </div>
                </div>
                <div class="pb-quarter d-block d-lg-none"></div>
            ...
            <div class="row p-left-right">
                <div class="col-12 col-lg-3">
                    <div class="row d-flex align-items-center ">
                        ...
                        <div class="pb-quarter d-none d-lg-block"></div>
                        <!-- <div class="col-6 col-lg-12 d-flex justify-content-end justify-content-lg-start">
                        <img class="img-icon-planet" src="/wp-content/themes/andcowoman/img/and-co-woman-trvl.svg">    
                    </div> -->
                    </div>
                </div>
                <div class="pb-quarter d-block d-lg-none"></div>
